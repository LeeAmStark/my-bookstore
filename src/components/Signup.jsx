  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response.data === "Email is already registered") {
        ...
        alert(error.response.data.email || error.response.data.username);
        return;
      }
    }
  };
      ...
      <div className="bg-slate-300 w-96 p-8 text-center flex flex-col gap-8 shadow-xl rounded-lg">
        ...
        >
          ...
          <div className="flex flex-col content-center justify-center">
            <h2 className="text-base font-bold w-32">Account Type</h2>
            <select name="accountType" className="h-8 w-24 rounded-md">
